<template>
    <b-dropdown
        ...
        no-flip
        :text="displayName(localValue.nameForOptionList)"
    >
...
export default {
        ...
        availableOptions() {
            ...
            if (criteria) {
                ...
                return this.options.filter(
                    opt =>
                        opt.nameForOptionList.toLowerCase().indexOf(criteria) >
                        -1
                );
            }
    ...
    methods: {
        onOptionClick(option) {
            this.$log.debug(
                'id=' + option.id + ', name=' + option.nameForOptionList
            );
