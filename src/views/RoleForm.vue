                                ...
                                <b-row>
                                    <b-col>
                                        <b-form-group
                                                ...
                                                label-for="name"
                                        >
                                            <b-form-input id="name" v-model="role.name" placeholder="enter role name" trim style="max-width: 10rem"></b-form-input>
                                        </b-form-group>
                                ...
                                <b-row class="mt-2">
                                    <b-col>
                                        <b-button-group class="float-right">
                                            ...
                                            <b-button to="/roles" type="reset" variant="outline-danger">cancel</b-button>
                                        </b-button-group>
                                    </b-col>
                                </b-row>
                            </b-card-body>
      ...
      onSubmit(evt) {
        ...
        if (this.$route.path.endsWith("new")) {
          this.$api
            ...
            .then(response => (this.role = response.data, this.$router.push("/roles")))
            .catch(error => {
              console.log(error);
              this.errored = true;
            });
